    ...
    <>
      <header className="flex justify-between py-2 md:py-4 px-5 md:px-30">
        ...
        <div className="flex gap-2 md:gap-4 justify-center items-center">
          ...
          <button className="bg-yellow-800 hover:bg-yellow-700 md:py-1 px-2 md:px-4 rounded-lg md:rounded-xl text-white hover:cursor-pointer"><Link to="/">Home</Link></button>
        </div>
      </header>
    </>
  );
